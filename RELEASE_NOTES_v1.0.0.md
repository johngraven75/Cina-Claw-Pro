# Cina-Claw Pro v1.0.0

## Highlights

- Windows-first animated AI command center with layered 3D visual effects.
- Embedded OpenClaw 2026.7.1, multimodal chat, file previews, browser tools, agents, channels, and scheduled automations.
- Free-first presets for OpenRouter, Gemini Flash, and local Ollama.
- Guarded autonomous defaults: planning, bounded code mode, delegation, allowlisted execution, and approval on misses.
- Windows OS-backed encryption for provider credentials with transparent migration from older stores.
