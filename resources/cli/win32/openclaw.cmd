...
if /i "%1"=="update" (
    echo openclaw is managed by Cina-Claw Pro ^(bundled version^).
    echo.
    echo To update openclaw, update Cina-Claw Pro:
    echo   Open Cina-Claw Pro ^> Settings ^> Check for Updates
    echo   Or download the latest version from https://github.com/johngraven75/Cina-Claw-Pro/releases
    exit /b 0
)
...
set OPENCLAW_EMBEDDED_IN=Cina-Claw Pro
...
if "%_USE_BUNDLED_NODE%"=="1" (
    ...
    "%~dp0..\..\Cina-Claw Pro.exe" "%OPENCLAW_ENTRY%" %*
)
