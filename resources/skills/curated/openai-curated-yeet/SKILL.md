---
name: openai-curated-yeet
description: "CinaClaw Pro adapter for the official OpenAI Yeet skill concept. Use when the user asks to perform the Yeet workflow with CinaClaw tools and user-approved external services."
---

# Yeet

> Adapter: `cina-openrouter-free-v1` · Concept source: `openai/skills/skills/.curated/yeet`

Use this original CinaClaw Pro workflow adapter when the request matches the **Yeet** capability. It is independently adapted from the official OpenAI Skills Catalog concept and does not copy upstream skill instructions, scripts, or assets.
