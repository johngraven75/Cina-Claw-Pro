---
name: openai-curated-playwright-interactive
description: "CinaClaw Pro adapter for the official OpenAI Playwright Interactive skill concept. Use when the user asks to perform interactive browser verification with explicit targets and observable results."
---

# Playwright Interactive

> Adapter: `cina-openrouter-free-v1` · Concept source: `openai/skills/skills/.curated/playwright-interactive`

Use this original CinaClaw Pro workflow adapter when the request matches the **Playwright Interactive** capability. It is independently adapted from the official OpenAI Skills Catalog concept and does not copy upstream skill instructions, scripts, or assets.
