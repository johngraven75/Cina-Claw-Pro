---
name: openai-curated-screenshot
description: "CinaClaw Pro adapter for the official OpenAI Screenshot skill concept. Use when the user asks to perform the Screenshot workflow with CinaClaw tools and user-approved external services."
---

# Screenshot

> Adapter: `cina-openrouter-free-v1` · Concept source: `openai/skills/skills/.curated/screenshot`

Use this original CinaClaw Pro workflow adapter when the request matches the **Screenshot** capability. It is independently adapted from the official OpenAI Skills Catalog concept and does not copy upstream skill instructions, scripts, or assets.
