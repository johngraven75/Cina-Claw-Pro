---
name: openai-system-skill-creator
description: "CinaClaw Pro adapter for the official OpenAI Skill Creator skill concept. Use when the user asks to perform the Skill Creator workflow with CinaClaw tools and user-approved external services."
---

# Skill Creator

> Adapter: `cina-openrouter-free-v1` · Concept source: `openai/skills/skills/.system/skill-creator`

Use this original CinaClaw Pro workflow adapter when the request matches the **Skill Creator** capability. It is independently adapted from the official OpenAI Skills Catalog concept and does not copy upstream skill instructions, scripts, or assets.
