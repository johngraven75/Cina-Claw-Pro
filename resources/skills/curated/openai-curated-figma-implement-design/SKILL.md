---
name: openai-curated-figma-implement-design
description: "CinaClaw Pro adapter for the official OpenAI Figma Implement Design skill concept. Use when the user asks to perform the Figma Implement Design workflow with CinaClaw tools and user-approved external services."
---

# Figma Implement Design

> Adapter: `cina-openrouter-free-v1` · Concept source: `openai/skills/skills/.curated/figma-implement-design`

Use this original CinaClaw Pro workflow adapter when the request matches the **Figma Implement Design** capability. It is independently adapted from the official OpenAI Skills Catalog concept and does not copy upstream skill instructions, scripts, or assets.
