---
name: openai-curated-security-best-practices
description: "CinaClaw Pro adapter for the official OpenAI Security Best Practices skill concept. Use when the user asks to review application code against practical security safeguards and explain the evidence behind findings."
---

# Security Best Practices

> Adapter: `cina-openrouter-free-v1` · Concept source: `openai/skills/skills/.curated/security-best-practices`

Use this original CinaClaw Pro workflow adapter when the request matches the **Security Best Practices** capability. It is independently adapted from the official OpenAI Skills Catalog concept and does not copy upstream skill instructions, scripts, or assets.
