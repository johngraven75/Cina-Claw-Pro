---
name: openai-curated-cloudflare-deploy
description: "CinaClaw Pro adapter for the official OpenAI Cloudflare Deploy skill concept. Use when the user asks to perform the Cloudflare Deploy workflow with CinaClaw tools and user-approved external services."
---

# Cloudflare Deploy

> Adapter: `cina-openrouter-free-v1` · Concept source: `openai/skills/skills/.curated/cloudflare-deploy`

Use this original CinaClaw Pro workflow adapter when the request matches the **Cloudflare Deploy** capability. It is independently adapted from the official OpenAI Skills Catalog concept and does not copy upstream skill instructions, scripts, or assets.
