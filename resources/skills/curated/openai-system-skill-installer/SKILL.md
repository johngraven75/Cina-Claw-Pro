---
name: openai-system-skill-installer
description: "CinaClaw Pro adapter for the official OpenAI Skill Installer skill concept. Use when the user asks to review and install approved skills through CinaClaw-managed sources without enabling unreviewed content automatically."
---

# Skill Installer

> Adapter: `cina-openrouter-free-v1` · Concept source: `openai/skills/skills/.system/skill-installer`

Use this original CinaClaw Pro workflow adapter when the request matches the **Skill Installer** capability. It is independently adapted from the official OpenAI Skills Catalog concept and does not copy upstream skill instructions, scripts, or assets.
