---
name: openai-curated-playwright
description: "CinaClaw Pro adapter for the official OpenAI Playwright skill concept. Use when the user asks to write or repair browser tests using the locally available Playwright tooling."
---

# Playwright

> Adapter: `cina-openrouter-free-v1` · Concept source: `openai/skills/skills/.curated/playwright`

Use this original CinaClaw Pro workflow adapter when the request matches the **Playwright** capability. It is independently adapted from the official OpenAI Skills Catalog concept and does not copy upstream skill instructions, scripts, or assets.
