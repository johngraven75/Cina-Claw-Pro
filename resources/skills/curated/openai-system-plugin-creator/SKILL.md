---
name: openai-system-plugin-creator
description: "CinaClaw Pro adapter for the official OpenAI Plugin Creator skill concept. Use when the user asks to scaffold a local plugin configuration and validate it before any separate operator-approved enablement."
---

# Plugin Creator

> Adapter: `cina-openrouter-free-v1` · Concept source: `openai/skills/skills/.system/plugin-creator`

Use this original CinaClaw Pro workflow adapter when the request matches the **Plugin Creator** capability. It is independently adapted from the official OpenAI Skills Catalog concept and does not copy upstream skill instructions, scripts, or assets.
