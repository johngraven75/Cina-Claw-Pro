---
name: openai-curated-notion-meeting-intelligence
description: "CinaClaw Pro adapter for the official OpenAI Notion Meeting Intelligence skill concept. Use when the user asks to perform the Notion Meeting Intelligence workflow with CinaClaw tools and user-approved external services."
---

# Notion Meeting Intelligence

> Adapter: `cina-openrouter-free-v1` · Concept source: `openai/skills/skills/.curated/notion-meeting-intelligence`

Use this original CinaClaw Pro workflow adapter when the request matches the **Notion Meeting Intelligence** capability. It is independently adapted from the official OpenAI Skills Catalog concept and does not copy upstream skill instructions, scripts, or assets.
