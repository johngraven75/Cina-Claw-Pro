---
name: openai-curated-figma-code-connect-components
description: "CinaClaw Pro adapter for the official OpenAI Figma Code Connect Components skill concept. Use when the user asks to perform the Figma Code Connect Components workflow with CinaClaw tools and user-approved external services."
---

# Figma Code Connect Components

> Adapter: `cina-openrouter-free-v1` · Concept source: `openai/skills/skills/.curated/figma-code-connect-components`

Use this original CinaClaw Pro workflow adapter when the request matches the **Figma Code Connect Components** capability. It is independently adapted from the official OpenAI Skills Catalog concept and does not copy upstream skill instructions, scripts, or assets.
