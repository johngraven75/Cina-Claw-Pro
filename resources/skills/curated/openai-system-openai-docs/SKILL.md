---
name: openai-system-openai-docs
description: "CinaClaw Pro adapter for the official OpenAI Openai Docs skill concept. Use when the user asks to research current OpenAI or Codex documentation using available official documentation sources."
---

# Openai Docs

> Adapter: `cina-openrouter-free-v1` · Concept source: `openai/skills/skills/.system/openai-docs`

Use this original CinaClaw Pro workflow adapter when the request matches the **Openai Docs** capability. It is independently adapted from the official OpenAI Skills Catalog concept and does not copy upstream skill instructions, scripts, or assets.
