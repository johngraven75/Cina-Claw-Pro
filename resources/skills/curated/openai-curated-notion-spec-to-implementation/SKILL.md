---
name: openai-curated-notion-spec-to-implementation
description: "CinaClaw Pro adapter for the official OpenAI Notion Spec To Implementation skill concept. Use when the user asks to perform the Notion Spec To Implementation workflow with CinaClaw tools and user-approved external services."
---

# Notion Spec To Implementation

> Adapter: `cina-openrouter-free-v1` · Concept source: `openai/skills/skills/.curated/notion-spec-to-implementation`

Use this original CinaClaw Pro workflow adapter when the request matches the **Notion Spec To Implementation** capability. It is independently adapted from the official OpenAI Skills Catalog concept and does not copy upstream skill instructions, scripts, or assets.
