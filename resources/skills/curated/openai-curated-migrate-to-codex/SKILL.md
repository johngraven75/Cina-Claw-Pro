---
name: openai-curated-migrate-to-codex
description: "CinaClaw Pro adapter for the official OpenAI Migrate To Codex skill concept. Use when the user asks to inventory and migrate selected agent instructions or configuration into a Codex-compatible project structure without modifying unrelated files."
---

# Migrate To Codex

> Adapter: `cina-openrouter-free-v1` · Concept source: `openai/skills/skills/.curated/migrate-to-codex`

Use this original CinaClaw Pro workflow adapter when the request matches the **Migrate To Codex** capability. It is independently adapted from the official OpenAI Skills Catalog concept and does not copy upstream skill instructions, scripts, or assets.
