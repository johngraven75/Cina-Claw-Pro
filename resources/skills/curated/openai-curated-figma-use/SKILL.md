---
name: openai-curated-figma-use
description: "CinaClaw Pro adapter for the official OpenAI Figma Use skill concept. Use when the user asks to perform the Figma Use workflow with CinaClaw tools and user-approved external services."
---

# Figma Use

> Adapter: `cina-openrouter-free-v1` · Concept source: `openai/skills/skills/.curated/figma-use`

Use this original CinaClaw Pro workflow adapter when the request matches the **Figma Use** capability. It is independently adapted from the official OpenAI Skills Catalog concept and does not copy upstream skill instructions, scripts, or assets.
