---
name: openai-curated-security-threat-model
description: "CinaClaw Pro adapter for the official OpenAI Security Threat Model skill concept. Use when the user asks to create a scoped threat model based on the target system, data flows, and available evidence."
---

# Security Threat Model

> Adapter: `cina-openrouter-free-v1` · Concept source: `openai/skills/skills/.curated/security-threat-model`

Use this original CinaClaw Pro workflow adapter when the request matches the **Security Threat Model** capability. It is independently adapted from the official OpenAI Skills Catalog concept and does not copy upstream skill instructions, scripts, or assets.
