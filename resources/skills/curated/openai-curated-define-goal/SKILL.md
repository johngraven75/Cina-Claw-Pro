---
name: openai-curated-define-goal
description: "CinaClaw Pro adapter for the official OpenAI Define Goal skill concept. Use when the user asks to perform the Define Goal workflow with CinaClaw tools and user-approved external services."
---

# Define Goal

> Adapter: `cina-openrouter-free-v1` · Concept source: `openai/skills/skills/.curated/define-goal`

Use this original CinaClaw Pro workflow adapter when the request matches the **Define Goal** capability. It is independently adapted from the official OpenAI Skills Catalog concept and does not copy upstream skill instructions, scripts, or assets.
