---
name: openai-curated-speech
description: "CinaClaw Pro adapter for the official OpenAI Speech skill concept. Use when the user asks to prepare or generate speech output only when a compatible speech provider is configured."
---

# Speech

> Adapter: `cina-openrouter-free-v1` · Concept source: `openai/skills/skills/.curated/speech`

Use this original CinaClaw Pro workflow adapter when the request matches the **Speech** capability. It is independently adapted from the official OpenAI Skills Catalog concept and does not copy upstream skill instructions, scripts, or assets.
