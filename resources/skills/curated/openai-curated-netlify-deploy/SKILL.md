---
name: openai-curated-netlify-deploy
description: "CinaClaw Pro adapter for the official OpenAI Netlify Deploy skill concept. Use when the user asks to perform the Netlify Deploy workflow with CinaClaw tools and user-approved external services."
---

# Netlify Deploy

> Adapter: `cina-openrouter-free-v1` · Concept source: `openai/skills/skills/.curated/netlify-deploy`

Use this original CinaClaw Pro workflow adapter when the request matches the **Netlify Deploy** capability. It is independently adapted from the official OpenAI Skills Catalog concept and does not copy upstream skill instructions, scripts, or assets.
