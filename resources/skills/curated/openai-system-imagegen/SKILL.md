---
name: openai-system-imagegen
description: "CinaClaw Pro adapter for the official OpenAI Imagegen skill concept. Use when the user asks to create or edit images only when a compatible CinaClaw image-generation capability is installed and enabled."
---

# Imagegen

> Adapter: `cina-openrouter-free-v1` · Concept source: `openai/skills/skills/.system/imagegen`

Use this original CinaClaw Pro workflow adapter when the request matches the **Imagegen** capability. It is independently adapted from the official OpenAI Skills Catalog concept and does not copy upstream skill instructions, scripts, or assets.
