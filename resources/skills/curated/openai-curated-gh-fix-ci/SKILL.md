---
name: openai-curated-gh-fix-ci
description: "CinaClaw Pro adapter for the official OpenAI Gh Fix Ci skill concept. Use when the user asks to investigate and repair a failing GitHub Actions workflow using reproducible local checks before retrying hosted validation."
---

# Gh Fix Ci

> Adapter: `cina-openrouter-free-v1` · Concept source: `openai/skills/skills/.curated/gh-fix-ci`

Use this original CinaClaw Pro workflow adapter when the request matches the **Gh Fix Ci** capability. It is independently adapted from the official OpenAI Skills Catalog concept and does not copy upstream skill instructions, scripts, or assets.
