---
name: openai-curated-sentry
description: "CinaClaw Pro adapter for the official OpenAI Sentry skill concept. Use when the user asks to perform the Sentry workflow with CinaClaw tools and user-approved external services."
---

# Sentry

> Adapter: `cina-openrouter-free-v1` · Concept source: `openai/skills/skills/.curated/sentry`

Use this original CinaClaw Pro workflow adapter when the request matches the **Sentry** capability. It is independently adapted from the official OpenAI Skills Catalog concept and does not copy upstream skill instructions, scripts, or assets.
