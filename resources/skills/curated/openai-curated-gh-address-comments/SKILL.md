---
name: openai-curated-gh-address-comments
description: "CinaClaw Pro adapter for the official OpenAI Gh Address Comments skill concept. Use when the user asks to address review feedback in a GitHub repository after inspecting the exact comments and affected code."
---

# Gh Address Comments

> Adapter: `cina-openrouter-free-v1` · Concept source: `openai/skills/skills/.curated/gh-address-comments`

Use this original CinaClaw Pro workflow adapter when the request matches the **Gh Address Comments** capability. It is independently adapted from the official OpenAI Skills Catalog concept and does not copy upstream skill instructions, scripts, or assets.
