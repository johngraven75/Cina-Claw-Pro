---
name: openai-curated-vercel-deploy
description: "CinaClaw Pro adapter for the official OpenAI Vercel Deploy skill concept. Use when the user asks to perform the Vercel Deploy workflow with CinaClaw tools and user-approved external services."
---

# Vercel Deploy

> Adapter: `cina-openrouter-free-v1` · Concept source: `openai/skills/skills/.curated/vercel-deploy`

Use this original CinaClaw Pro workflow adapter when the request matches the **Vercel Deploy** capability. It is independently adapted from the official OpenAI Skills Catalog concept and does not copy upstream skill instructions, scripts, or assets.
