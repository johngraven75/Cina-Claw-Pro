---
name: openai-curated-pdf
description: "CinaClaw Pro adapter for the official OpenAI Pdf skill concept. Use when the user asks to perform the Pdf workflow with CinaClaw tools and user-approved external services."
---

# Pdf

> Adapter: `cina-openrouter-free-v1` · Concept source: `openai/skills/skills/.curated/pdf`

Use this original CinaClaw Pro workflow adapter when the request matches the **Pdf** capability. It is independently adapted from the official OpenAI Skills Catalog concept and does not copy upstream skill instructions, scripts, or assets.
