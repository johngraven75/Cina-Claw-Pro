---
name: openai-curated-figma-create-design-system-rules
description: "CinaClaw Pro adapter for the official OpenAI Figma Create Design System Rules skill concept. Use when the user asks to perform the Figma Create Design System Rules workflow with CinaClaw tools and user-approved external services."
---

# Figma Create Design System Rules

> Adapter: `cina-openrouter-free-v1` · Concept source: `openai/skills/skills/.curated/figma-create-design-system-rules`

Use this original CinaClaw Pro workflow adapter when the request matches the **Figma Create Design System Rules** capability. It is independently adapted from the official OpenAI Skills Catalog concept and does not copy upstream skill instructions, scripts, or assets.
