---
name: openai-curated-cli-creator
description: "CinaClaw Pro adapter for the official OpenAI Cli Creator skill concept. Use when the user asks to perform the Cli Creator workflow with CinaClaw tools and user-approved external services."
---

# Cli Creator

> Adapter: `cina-openrouter-free-v1` · Concept source: `openai/skills/skills/.curated/cli-creator`

Use this original CinaClaw Pro workflow adapter when the request matches the **Cli Creator** capability. It is independently adapted from the official OpenAI Skills Catalog concept and does not copy upstream skill instructions, scripts, or assets.
