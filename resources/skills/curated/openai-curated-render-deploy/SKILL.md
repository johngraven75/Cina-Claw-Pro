---
name: openai-curated-render-deploy
description: "CinaClaw Pro adapter for the official OpenAI Render Deploy skill concept. Use when the user asks to perform the Render Deploy workflow with CinaClaw tools and user-approved external services."
---

# Render Deploy

> Adapter: `cina-openrouter-free-v1` · Concept source: `openai/skills/skills/.curated/render-deploy`

Use this original CinaClaw Pro workflow adapter when the request matches the **Render Deploy** capability. It is independently adapted from the official OpenAI Skills Catalog concept and does not copy upstream skill instructions, scripts, or assets.
