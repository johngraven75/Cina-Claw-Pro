---
name: openai-curated-figma-create-new-file
description: "CinaClaw Pro adapter for the official OpenAI Figma Create New File skill concept. Use when the user asks to perform the Figma Create New File workflow with CinaClaw tools and user-approved external services."
---

# Figma Create New File

> Adapter: `cina-openrouter-free-v1` · Concept source: `openai/skills/skills/.curated/figma-create-new-file`

Use this original CinaClaw Pro workflow adapter when the request matches the **Figma Create New File** capability. It is independently adapted from the official OpenAI Skills Catalog concept and does not copy upstream skill instructions, scripts, or assets.
