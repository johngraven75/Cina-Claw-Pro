...
description: "CinaClaw Pro adapter for the official OpenAI Jupyter Notebook skill concept. Use when the user asks to perform the Jupyter Notebook workflow with CinaClaw tools and user-approved external services."
---

# Jupyter Notebook

> Adapter: `cina-openrouter-free-v1` · Concept source: `openai/skills/skills/.curated/jupyter-notebook`

Use this original CinaClaw Pro workflow adapter when the request matches the **Jupyter Notebook** capability. It is independently adapted from the official OpenAI Skills Catalog concept and does not copy upstream skill instructions, scripts, or assets.
