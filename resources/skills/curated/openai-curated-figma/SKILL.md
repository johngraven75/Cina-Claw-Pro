---
name: openai-curated-figma
description: "CinaClaw Pro adapter for the official OpenAI Figma skill concept. Use when the user asks to perform the Figma workflow with CinaClaw tools and user-approved external services."
---

# Figma

> Adapter: `cina-openrouter-free-v1` · Concept source: `openai/skills/skills/.curated/figma`

Use this original CinaClaw Pro workflow adapter when the request matches the **Figma** capability. It is independently adapted from the official OpenAI Skills Catalog concept and does not copy upstream skill instructions, scripts, or assets.
