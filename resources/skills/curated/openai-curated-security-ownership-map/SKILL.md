---
name: openai-curated-security-ownership-map
description: "CinaClaw Pro adapter for the official OpenAI Security Ownership Map skill concept. Use when the user asks to map code ownership and security-sensitive responsibility using repository evidence."
---

# Security Ownership Map

> Adapter: `cina-openrouter-free-v1` · Concept source: `openai/skills/skills/.curated/security-ownership-map`

Use this original CinaClaw Pro workflow adapter when the request matches the **Security Ownership Map** capability. It is independently adapted from the official OpenAI Skills Catalog concept and does not copy upstream skill instructions, scripts, or assets.
