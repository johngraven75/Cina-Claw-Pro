---
name: openai-curated-notion-research-documentation
description: "CinaClaw Pro adapter for the official OpenAI Notion Research Documentation skill concept. Use when the user asks to perform the Notion Research Documentation workflow with CinaClaw tools and user-approved external services."
---

# Notion Research Documentation

> Adapter: `cina-openrouter-free-v1` · Concept source: `openai/skills/skills/.curated/notion-research-documentation`

Use this original CinaClaw Pro workflow adapter when the request matches the **Notion Research Documentation** capability. It is independently adapted from the official OpenAI Skills Catalog concept and does not copy upstream skill instructions, scripts, or assets.
