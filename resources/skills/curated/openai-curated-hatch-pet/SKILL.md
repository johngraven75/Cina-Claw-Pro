---
name: openai-curated-hatch-pet
description: "CinaClaw Pro adapter for the official OpenAI Hatch Pet skill concept. Use when the user asks to perform the Hatch Pet workflow with CinaClaw tools and user-approved external services."
---

# Hatch Pet

> Adapter: `cina-openrouter-free-v1` · Concept source: `openai/skills/skills/.curated/hatch-pet`

Use this original CinaClaw Pro workflow adapter when the request matches the **Hatch Pet** capability. It is independently adapted from the official OpenAI Skills Catalog concept and does not copy upstream skill instructions, scripts, or assets.
