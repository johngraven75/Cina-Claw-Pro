...
description: "CinaClaw Pro adapter for the official OpenAI Transcribe skill concept. Use when the user asks to transcribe local audio or video using an available CinaClaw transcription capability."
---

# Transcribe

> Adapter: `cina-openrouter-free-v1` · Concept source: `openai/skills/skills/.curated/transcribe`

Use this original CinaClaw Pro workflow adapter when the request matches the **Transcribe** capability. It is independently adapted from the official OpenAI Skills Catalog concept and does not copy upstream skill instructions, scripts, or assets.
