---
name: openai-curated-winui-app
description: "CinaClaw Pro adapter for the official OpenAI Winui App skill concept. Use when the user asks to perform the Winui App workflow with CinaClaw tools and user-approved external services."
---

# Winui App

> Adapter: `cina-openrouter-free-v1` · Concept source: `openai/skills/skills/.curated/winui-app`

Use this original CinaClaw Pro workflow adapter when the request matches the **Winui App** capability. It is independently adapted from the official OpenAI Skills Catalog concept and does not copy upstream skill instructions, scripts, or assets.
