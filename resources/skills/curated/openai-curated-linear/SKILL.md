---
name: openai-curated-linear
description: "CinaClaw Pro adapter for the official OpenAI Linear skill concept. Use when the user asks to perform the Linear workflow with CinaClaw tools and user-approved external services."
---

# Linear

> Adapter: `cina-openrouter-free-v1` · Concept source: `openai/skills/skills/.curated/linear`

Use this original CinaClaw Pro workflow adapter when the request matches the **Linear** capability. It is independently adapted from the official OpenAI Skills Catalog concept and does not copy upstream skill instructions, scripts, or assets.
