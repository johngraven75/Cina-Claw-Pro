---
name: openai-curated-aspnet-core
description: "CinaClaw Pro adapter for the official OpenAI Aspnet Core skill concept. Use when the user asks to perform the Aspnet Core workflow with CinaClaw tools and user-approved external services."
---

# Aspnet Core

> Adapter: `cina-openrouter-free-v1` · Concept source: `openai/skills/skills/.curated/aspnet-core`

Use this original CinaClaw Pro workflow adapter when the request matches the **Aspnet Core** capability. It is independently adapted from the official OpenAI Skills Catalog concept and does not copy upstream skill instructions, scripts, or assets.
