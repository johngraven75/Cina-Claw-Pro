---
name: openai-curated-figma-generate-library
description: "CinaClaw Pro adapter for the official OpenAI Figma Generate Library skill concept. Use when the user asks to perform the Figma Generate Library workflow with CinaClaw tools and user-approved external services."
---

# Figma Generate Library

> Adapter: `cina-openrouter-free-v1` · Concept source: `openai/skills/skills/.curated/figma-generate-library`

Use this original CinaClaw Pro workflow adapter when the request matches the **Figma Generate Library** capability. It is independently adapted from the official OpenAI Skills Catalog concept and does not copy upstream skill instructions, scripts, or assets.
