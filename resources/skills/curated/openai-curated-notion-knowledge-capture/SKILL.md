---
name: openai-curated-notion-knowledge-capture
description: "CinaClaw Pro adapter for the official OpenAI Notion Knowledge Capture skill concept. Use when the user asks to perform the Notion Knowledge Capture workflow with CinaClaw tools and user-approved external services."
---

# Notion Knowledge Capture

> Adapter: `cina-openrouter-free-v1` · Concept source: `openai/skills/skills/.curated/notion-knowledge-capture`

Use this original CinaClaw Pro workflow adapter when the request matches the **Notion Knowledge Capture** capability. It is independently adapted from the official OpenAI Skills Catalog concept and does not copy upstream skill instructions, scripts, or assets.
