            ...
            <div className="space-y-3 text-sm text-muted-foreground">
              ...
              <div className="flex gap-4 pt-3">
                <Button
                  ...
                  onClick={() => window.electron.openExternal('https://github.com/johngraven75/Cina-Claw-Pro#readme')}
                >
                  {t('about.docs')}
                </Button>
                <Button
                  variant="link"
                  className="h-auto p-0 text-sm text-blue-500 hover:text-blue-600 font-medium"
                  onClick={() => window.electron.openExternal('https://github.com/johngraven75/Cina-Claw-Pro')}
                >
                  {t('about.github')}
                </Button>
                <Button
