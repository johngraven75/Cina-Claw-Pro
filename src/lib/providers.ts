...
export const PROVIDER_TYPE_INFO: ProviderTypeInfo[] = [
  ...
  { id: 'ollama', name: 'Ollama', icon: '🦙', placeholder: 'Not required', requiresApiKey: false, defaultBaseUrl: 'http://localhost:11434/v1', showBaseUrl: true, showModelId: true, defaultModelId: 'gemma4:latest', modelIdPlaceholder: 'gemma4:latest' },
  {
    id: 'custom',
    name: 'Custom',
    icon: '⚙️',
