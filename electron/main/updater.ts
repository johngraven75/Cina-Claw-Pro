 ...
 *
 * Packaged builds use Cina-Claw Pro's GitHub Releases feed generated by electron-builder.
 */
...
export class AppUpdater extends EventEmitter {
  ...
  constructor() {
    ...
    logger.info(`[Updater] Version: ${version}, channel: ${channel}, provider: GitHub Releases`);
